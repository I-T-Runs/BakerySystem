...
public class NotificationSystem {
    ...
    public void NotificationSystem(){
        this.userName="bakery.system.notifier@gmail.com";
        this.password="BSEmailPass1";
 
    }
 
    public String sendGmail(String from, String to, String subject, String text){
...
//            JOptionPane.showMessageDialog(null, "Mail sent successfully ...","Mail sent",JOptionPane.PLAIN_MESSAGE);
            ...
            e.printStackTrace();
            return "Sending email to: \" + to + \" failed !!!";
//            JOptionPane.showMessageDialog(null, "Sending email to: " + to + " failed !!!", "Falied to Send!!!", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String[] args) {
        ...
        String mailFrom=new String("bakery.system.notifier@gmail.com");
        //Sender must be a Gmail Account holder
 
        String mailTo=new String("kingzwide4@gmail.com");
        //but here you can send to any type of mail account
 
 
        //subject and content
        String mailSubject=new String("Send Emails in Java test");
        String mailText=new String("Alright so this is the test for the email notification system!!!");
 

        NotificationSystem newGmailClient=new NotificationSystem(); 
        //Send mail
