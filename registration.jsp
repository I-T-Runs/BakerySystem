...
<html>
    ...
    <editor-fold defaultstate="collapsed" desc="reg">
        <div id="signupf" class="card">
            <form id="Sign Up" class="" action="register" method="POST">
                <div class="w3-container">
                    ...
                    <button type="submit" onclick="document.getElementById('shop.jsp.jsp').style.display = 'none'">Sign Up</button>

                    <button type="button" onclick="window.open('login.jsp').style.display = 'none'" class="">Cancel</button>
