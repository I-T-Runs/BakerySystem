package com.tempbakery.coreclasses;
...
public class EmailBroadcaster {
	...
	public void setAccountDetails(String systemEmail,String systemEmailPassword){
		...
		this.systemEmail=systemEmail;//sender's email can also use as User Name
...
//		//TODO : Remove security thingy from the gmail account
//		String mailFrom="**********@gmail.com";
//		String mailTo="**********@gmail.com";
//
//		// email that'll be used
//		String accPassword="***********";
//		String accUsername="***********@gmail.com";
//
//		// YET TO DO THE ATTATCHMENT ONE
//		String mailSubject="Send Emails in Java test";
//		String mailText="Alright so this is the test for the email notification system!!!";
//
//		EmailBroadcaster notifier=new EmailBroadcaster();
//
//		notifier.setAccountDetails(accUsername, accPassword);
//		notifier.sendGmail(mailFrom, mailTo, mailSubject, mailText);
//	}
