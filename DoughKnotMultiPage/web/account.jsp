    ...
    <body>
        ...
        <nav class="w3-sidebar w3-white w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                <a href="#account" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">ACCOUNT DETAILS</a> 
                <a href="#editacc" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">VIEW CART</a> 
                <a href="#" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">ORDER HISTORY</a> 
                <a href="#" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">SHOP</a> 
            </div>
        </nav>
        ...
        <div class="w3-main" style="margin-left:340px;margin-right:40px">
            ...
            <!-- View Cart -->
            <editor-fold defaultstate="collapsed" desc="Sign In">
                <div id="viewcart" class="">
                    <h2>Your Cart</h2></br>

                    <div class="w3-container">
                        <% Cart cart1 = new Cart(); %>
                        <% ArrayList<ProductLineItem> cartArr1 = new ArrayList<>(); %>
                        <% cartArr1.add(new ProductLineItem(1, "cookie", 1)); %>
                        <% cartArr1.add(new ProductLineItem(2, "Brownie", 1)); %>
                        <% cartArr1.add(new ProductLineItem(3, "cake", 1)); %>
                        <% cart1.setProducts(cartArr1); %>
                        <% for (ProductLineItem pli : cartArr1) {%>
