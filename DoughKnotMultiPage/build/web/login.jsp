        ...
        <div id="signinf">
            <form class="" action="login" method="POST">
                ...
                <div class="w3-container">
                    ...
                    <button type="submit" type="submit">Login</button>
                    ...
                    <br/><br/><br/>
                    <span class="psw">Forgot <a onclick="window.open('passwordrecovery.jsp').style.display = 'block'" style="color: ff0000;">password?</a></span>
                </div>
            </form>
        </div>
